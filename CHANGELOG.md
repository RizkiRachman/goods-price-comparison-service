...
### Fixed
- **Null pointer during create receipt**: Added `imageHash` validation via `HashUtils.sha256` from items JSON to prevent null pointer exception in `ReceiptService.create()`
